...
with st.expander("Enter Patient Demographic Data", expanded=True):
...
bsa = col1.number_input('BSA', min_value=0.0, max_value=3.0, step=0.01)
...
pm_sax_meas_c = col1.number_input('PM SAX Measurements C', min_value=0.0, max_value=10.0, step=0.01)
pm_sax_meas_d = col1.number_input('PM SAX Measurements D', min_value=0.0, max_value=10.0, step=0.01)

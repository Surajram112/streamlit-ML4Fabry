...
st.altair_chart(altair.Chart(pd.DataFrame({'Condition': ['Hypertrophic Cardiomyopathy', 'Fabry Disease'], 'Probability': prediction}), height=100).mark_bar().encode(x='Condition', y='Probability'))
